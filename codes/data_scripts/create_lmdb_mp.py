...
def vimeo7():
    ...
    if mode == 'GT':
        ...
        img_folder = '/media/data3/wh/data/dataset/SR/vimeo_septuplet/sequences/train'
        lmdb_save_path = '/media/data3/wh/data/dataset/SR/vimeo_septuplet/vimeo7_train_GT.lmdb'
        txt_file = '/media/data3/wh/data/dataset/SR/vimeo_septuplet/sep_trainlist.txt'

        H_dst, W_dst = 256, 448
    elif mode == 'LR':
        #### TODO: change your file path herec
        img_folder = '/media/data3/wh/data/dataset/SR/vimeo_septuplet/LR_train'
        lmdb_save_path = '/media/data3/wh/data/dataset/SR/vimeo_septuplet/vimeo7_train_LR7.lmdb'
        txt_file = '/media/data3/wh/data/dataset/SR/vimeo_septuplet/sep_trainlist.txt'
